glassProp = {"name":"glass", "k": 0.89}
cementProp = {"name":"cement", "k":1.4}
brickProp = {"name":"brick", "k":0.86}

materials = [glassProp,cementProp,brickProp] #Lista dei materiali
size_List = [0.2,0.35,0.45] #Lista delle misure
...
def materialSensitivity(materialList,serieSet,parallelSet,Ri,Ro,T_inside,T_outside):
    ...
    for gianluca in materials:
        ...
        name = gianluca["name"]
        for whatever in size_List:
            size = whatever["length"]
